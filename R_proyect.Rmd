...
print("Directorio graphics ya creado")
```
...
```{r include=FALSE}
ggsave(filename = paste0("graphics/", dim(df_test)[1], "_data_round_won_by_team.png"))
```
...
```{r include=FALSE}
ggsave(filename = paste0("graphics/", dim(df_test)[1], "_data_round_won_by_team_all_maps.png"))
```
...
```{r include=FALSE}
ggsave(filename = paste0("graphics/", dim(df_test)[1], "_data_logit_confusion_matrix.png"))
```
...
```{r include=FALSE}
ggsave(filename = paste0("graphics/", dim(df_test)[1], "_data_decision_tree_confusion_matrix.png"))
```
...
```{r include=FALSE}
ggsave(filename = paste0("graphics/", dim(df_test)[1], "_data_svm_polynomial_confusion_matrix.png"))
```
...
```{r include=FALSE}
ggsave(filename = paste0("graphics/", dim(df_test)[1], "_data_svm_radial_confusion_matrix.png"))
```
...
```{r include=FALSE}
ggsave(filename = paste0("graphics/", dim(df_test)[1], "_data_svm_sigmoid_confusion_matrix.png"))
```
...
```{r include=FALSE}
ggsave(filename = paste0("graphics/", dim(df_test)[1], "_data_ROC_curve_values.png"))
```
...
```{r include=FALSE}
ggsave(filename = paste0("graphics/", dim(df_test)[1], "_data_obtained_results.png"))
```
...
```{r include=FALSE}
ggsave(filename = paste0("graphics/accuracy_obtained.png"))
```
